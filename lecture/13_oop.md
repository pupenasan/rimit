...
Рис. 13.1 Зображення клапан на схемі автоматизації 
...
Розглянемо діаграму станів для операційної функції клапану. У найпростішому випадку клапан має два стани – «ВІДКРИТИЙ» та «ЗАКРИТИЙ». У залежності від наявності датчиків кінцевого положення, клапан може описуватися автоматами станів, що показані на Рис.13.3 Рисками на стрілах показані умови спрацювання переходів. На перший погляд, кожен з цих варіантів є самодостатнім. Однак кожен з них має ряд вад.  
...
1. Які ресурси згідно сучасних стандартів інтегрованого керування прийнято виділяти на виробництві?
2. Яке призначення ресурсу "устатковання" (equipment)?
3. Наведіть на прикладі клапану відмінність між об'єктним та функціональним представленням устатковання.
4. Що таке стан устатковання?
5. Яким чином можна представити в програмі користувача набір з кількох станів різних функціональних елементів?
6. Що таке автомати станів устатковання?
7. Що таке поняття режимів згідно ISA-88?
8. Що таке поширення режимів/станів між об'єктами в ієрархії?
9. Розкажіть про ієрархію устатковання. Які критерії декомпозиції можна використати для побудови ієрархії устатковання?
10. Покажіть на прикладі клапану ієрархію устатковання.
4. Як будується ієрархія устатковання підприємства згідно стандартів інтегрованого керування?
4. Які основні рівні ієрархії устатковання підприємства?      
