# Тема 8. Передача даних в архітектурі промислового Інтернету речей з використанням HTPP
...
рис.8.1.Принципи роботи WEB-API.
...
рис.8.2.Принципи роботи REST-API.
