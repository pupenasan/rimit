# Тема 5. Середовище Node-RED як інтеграційна платформа IIoT
...
рис.5.3.  Основні вузли Node-RED
...
рис.5.4. Використання Change для збереження в контекст.
